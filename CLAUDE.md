...
Project tasks live in Beads (`bd`). Run `bd prime` and use `.claude/skills/beads/SKILL.md` (mirrored at `.agents/skills/beads/SKILL.md`). Keep the local `.beads/` Dolt workspace out of git.
