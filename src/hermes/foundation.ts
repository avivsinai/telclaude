...
export const NoForkProofSchema = z
	.object({
		...
		expectedCommit: NonEmptyString.optional(),
		...
		runnerAttestation: z
			.object({
				...
				wrapperRunSchemaVersion: z.literal(NO_FORK_WRAPPER_RUN_SCHEMA_VERSION).optional(),
				wrapperRunSource: z.literal(NO_FORK_WRAPPER_RUN_SOURCE).optional(),
				wrapperRunRunner: z.literal(NO_FORK_WRAPPER_RUN_RUNNER).optional(),
				startedAt: NonEmptyString,
				endedAt: NonEmptyString,
...
export function buildCompatibilityLockfileDraft(input: {
	...
	return {
		...
		requiredUpgradeTests: [
			...
			"pnpm dev hermes verify-live --out <verify-live.json>",
		],
