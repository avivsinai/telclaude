...
const HERMES_FEATURE_PROBE_DEFINITIONS = [
	{
		...
		documented_seam:
			"Hermes top-level -z/--oneshot mode in hermes_cli/main.py and hermes_cli/oneshot.py",
		probe_command:
	...
	},
	{
		...
		probe_command:
			"pnpm dev hermes probe model.relay --allow-run --posture contained-internal --relay-url http://telclaude:8790/v1/models --model-url 'https://chatgpt.com/backend-api/codex/models?client_version=1.0.0' --profile-dir /home/hermes/.hermes --container-name tc-hermes-contained --expected-peer-address $TELCLAUDE_HERMES_CONTAINED_IP --relay-peer-address $TELCLAUDE_HERMES_RELAY_IP",
		expected_result:
