...
Currently supported:
- **clalit** - Clalit Health Services (medical records, appointments, prescriptions)
...
Make HTTP requests to the israel-services API:
...
2FA required (SMS code). Tell user to check phone and provide code via `/otp clalit <code>`.
