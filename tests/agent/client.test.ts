...
describe("executeRemoteQuery credential invariant", () => {
	...
	it("never serializes raw credentials to the agent — Docker mode", async () => {
	...
	it("never serializes raw credentials to the agent — native mode", async () => {
