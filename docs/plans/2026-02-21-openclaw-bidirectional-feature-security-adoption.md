...
1. **Never collapse telclaude into OpenClaw's in-process credential model.**
   - OpenClaw stores and uses provider credentials in agent/gateway process flows (`/home/user/workspace/openclaw/src/agents/auth-profiles/store.ts`, `/home/user/workspace/openclaw/src/agents/model-fallback.ts`).
...
2. **OpenClaw still lacks a mandatory outbound exfiltration blocker equivalent to telclaude's pipeline.**
   - OpenClaw primarily redacts logs (`/home/user/workspace/openclaw/src/logging/redact.ts`) and provides optional hook points (`/home/user/workspace/openclaw/src/plugins/hooks.ts`).
...
3. **Telclaude has clear feature depth gaps in onboarding and day-2 operations.**
   - OpenClaw has interactive + non-interactive onboarding and channel setup (`/home/user/workspace/openclaw/src/commands/onboard.ts`, `/home/user/workspace/openclaw/src/commands/onboard-interactive.ts`, `/home/user/workspace/openclaw/src/commands/onboard-non-interactive.ts`).
...
4. **OpenClaw has stronger multi-channel/account governance primitives.**
   - Channel plugin model, account-level status, allow-from/pairing flows (`/home/user/workspace/openclaw/src/channels/plugins/index.ts`, `/home/user/workspace/openclaw/src/commands/channels/status.ts`, `/home/user/workspace/openclaw/src/cli/pairing-cli.ts`, `/home/user/workspace/openclaw/src/pairing/pairing-store.ts`).
...
6. **OpenClaw runtime resilience (provider/model rotation) is ahead.**
   - Fallback and cooldown logic (`/home/user/workspace/openclaw/src/agents/model-fallback.ts`, `/home/user/workspace/openclaw/src/agents/auth-profiles/usage.ts`).
...
1. **Onboarding framework (interactive + non-interactive)**
   - Source: `/home/user/workspace/openclaw/src/commands/onboard.ts`, `/home/user/workspace/openclaw/src/commands/onboard-interactive.ts`, `/home/user/workspace/openclaw/src/commands/onboard-non-interactive.ts`.
...
2. **Operational status surfaces (status + sessions)**
   - Source: `/home/user/workspace/openclaw/src/commands/status.command.ts`, `/home/user/workspace/openclaw/src/commands/sessions.ts`.
...
3. **Pairing-style DM bootstrap and approval workflow**
   - Source: `/home/user/workspace/openclaw/src/cli/pairing-cli.ts`, `/home/user/workspace/openclaw/src/pairing/pairing-store.ts`, `/home/user/workspace/openclaw/src/pairing/pairing-messages.ts`.
...
4. **Cron scheduler CLI**
   - Source: `/home/user/workspace/openclaw/src/cli/cron-cli/register.ts`, `/home/user/workspace/openclaw/src/cli/cron-cli/register.cron-add.ts`.
...
5. **Model/provider auth profile rotation**
   - Source: `/home/user/workspace/openclaw/src/agents/model-fallback.ts`, `/home/user/workspace/openclaw/src/agents/auth-profiles/store.ts`, `/home/user/workspace/openclaw/src/agents/auth-profiles/usage.ts`.
...
6. **Reusable channel gating primitives**
   - Source: `/home/user/workspace/openclaw/src/channels/mention-gating.ts`, `/home/user/workspace/openclaw/src/channels/command-gating.ts`, `/home/user/workspace/openclaw/src/channels/allow-from.ts`.
...
7. **Draft stream improvements for long responses**
   - Source: `/home/user/workspace/openclaw/src/telegram/draft-stream.ts`.
...
8. **Pluginized channel architecture**
   - Source: `/home/user/workspace/openclaw/src/channels/plugins/*`.
...
9. **Memory backend fallback strategy (optional)**
   - Source: `/home/user/workspace/openclaw/src/memory/search-manager.ts`.
